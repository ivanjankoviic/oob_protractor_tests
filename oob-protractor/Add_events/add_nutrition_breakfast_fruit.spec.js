...
describe ("Add an check event nutrition breakfast Fruit - ", function(){
    console.log("Add an check event nutrition breakfast Fruit - ");
    ...
    it ("ADD event nutrition breakfast Fruit, check is there any events on calendar, check is there one event (nutrition breakfast Fruit)", function() {
        console.log("ADD event nutrition breakfast Fruit, check is there any events on calendar, check is there one event (nutrition breakfast Fruit)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Fruit');
