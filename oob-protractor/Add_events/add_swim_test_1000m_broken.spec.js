...
describe ("Add an check event Swim test 1000 m broken - ", function(){
    console.log("Add an check event Swim test 1000 m broken- ");
    ...
    it ("ADD event Swim test 1000 m broken, check is there any events on calendar, check is there one event (Swim test 1000 m broken)", function() {
        console.log("ADD event Swim test 1000 m broken, check is there any events on calendar, check is there one event (Swim test 1000 m broken)");
        ...
        //klik na Swim test 1000 m broken
        eventAdd.categoris.get(11).click();
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim test 1000 m broken 1h 00'");
