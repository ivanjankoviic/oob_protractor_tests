...
describe ("Add an check event nutrition snack Pastry - ", function(){
    console.log("Add an check event nutrition snack Pastry - ");
    ...
    it ("ADD event nutrition snack Pastry, check is there any events on calendar, check is there one event (nutrition snack Pastry)", function() {
        console.log("ADD event nutrition snack Pastry, check is there any events on calendar, check is there one event (nutrition snack Pastry)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Pastry');
