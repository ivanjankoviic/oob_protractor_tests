...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (clik on Lunch), check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (clik on Lunch), check if fields exist, and if they are named properly");
        //klik na Nutrition
