...
describe ("Add an check event Sickness - ", function(){
    console.log("Add an check event Sickness- ");
    ...
    it ("ADD event Sickness, check is there any events on calendar, check is there one event (Sickness)", function() {
        console.log("ADD event Sickness, check is there any events on calendar, check is there one event (Sickness)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Sickness');
