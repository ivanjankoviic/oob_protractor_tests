...
describe ("Add an check event chocolate - ", function(){
    console.log("Add an check event chocolate - ");
    ...
    afterAll(function (){
        ...
        it ("ADD event CHOCOLATE, check is there any events on calendar, check is there one event (CHOCOLATE), check names " +
        "of events in Nutrition ", function() {
            console.log("ADD event CHOCOLATE, check is there any events on calendar, check is there one event (CHOCOLATE), check names " +
                "of events in Nutrition ");
            ...
            expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Chocolate');
