...
describe ("Add an check event run test 10 km - ", function(){
    console.log("Add an check event 10 km - ");
    ...
    it ("ADD event run test 10 km, check is there any events on calendar, check is there one event (run test 10 km)", function() {
        console.log("ADD event run test 10 km, check is there any events on calendar, check is there one event (run test 10 km)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Run test 10 km 1h 00'");
