...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (click on Yoga), check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (click on Yoga, check if fields exist, and if they are named properly");
        ...
        browser.wait(EC.presenceOf(eventAdd.categoris), 10000);
        expect(eventAdd.categoris.get(0).getText()).toBe('Power yoga');
        expect(eventAdd.categoris.get(1).getText()).toBe('Yoga');
        expect(eventAdd.categoris.get(2).getText()).toBe('Bikram yoga');
        //klik na Power yoga
        eventAdd.categoris.get(0).click();
