...
describe ("Add an check event goal Weight loss - ", function(){
    console.log("Add an check event goal Weight loss - ");
    ...
    it ("ADD event goal Weight loss, check is there any events on calendar, check is there one event (goal Weight loss)", function() {
        console.log("ADD event goal Weight loss, check is there any events on calendar, check is there one event (goal Weight loss)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Weight loss');
