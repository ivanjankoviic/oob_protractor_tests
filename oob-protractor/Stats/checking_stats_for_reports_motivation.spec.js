...
describe ("Create 3 different events in present past and future, and delete them - ", function(){
    ...
    it ("Checking stats before and after adding event and after report that event. Event is 'Motivation'", function() {
        console.log("Checking stats before and after adding event and after report that event. Event is 'Motivation'");
        ...
        browser.findElements(by.id(current_day)).then(function() {
            expect(element(by.css( "#" + current_day + " oob-day .day-events-full .day-event-full:nth-child(1)")).getText()).toBe('Motivation');
        });
