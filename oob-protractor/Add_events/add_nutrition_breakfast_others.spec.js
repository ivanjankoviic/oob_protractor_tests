...
describe ("Add an check event nutrition breakfast Others - ", function(){
    console.log("Add an check event nutrition breakfast Others - ");
    ...
    it ("ADD event nutrition breakfast Others, check is there any events on calendar, check is there one event (nutrition breakfast Others)", function() {
        console.log("ADD event nutrition breakfast Others, check is there any events on calendar, check is there one event (nutrition breakfast Others)");
