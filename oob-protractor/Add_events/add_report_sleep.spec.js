...
describe ("Add an check event sleep - ", function(){
    console.log("Add an check event sleep - ");
    ...
    var reportEvent = new ReportEvent();
        ...
        it ("ADD event SLEEP, check is there any events on calendar, check is there one event (SLEEP), check names " +
            "of events in Reports ", function() {
            console.log("ADD event SLEEP, check is there any events on calendar, check is there one event (SLEEP), check names " +
                "of events in Reports ");
            ...
            expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Sleep');
