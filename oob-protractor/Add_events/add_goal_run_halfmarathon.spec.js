...
describe ("Add an check event goal Run Half marathon - ", function(){
    console.log("Add an check event goal Run Half marathon - ");
    ...
    it ("ADD event goal Run Half marathon, check is there any events on calendar, check is there one event (goal Run Half marathon)", function() {
        console.log("ADD event goal Run Half marathon, check is there any events on calendar, check is there one event (goal Run Half marathon)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Halfmarathon 1h 40'"); //kad se bude popravilo da pise Half marathon proci ce test
