...
describe ("Add an check event joging - ", function(){
    console.log("Add an check event joging - ");
    ...
    afterAll(function (){
        ...
        it ("ADD event JOGGING, check is there any events on calendar, check is there one event (JOGGING), check names " +
            "of events in Activity ", function() {
            console.log("ADD event JOGGING, check is there any events on calendar, check is there one event (JOGGING), check names " +
                "of events in Activity ");
