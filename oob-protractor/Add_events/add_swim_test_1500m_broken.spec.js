...
describe ("Add an check event Swim test 1500 m broken - ", function(){
    console.log("Add an check event Swim test 1500 m broken - ");
    ...
    it ("ADD event Swim test 1500 m broken, check is there any events on calendar, check is there one event (Swim test 1500 m broken)", function() {
        console.log("ADD event Swim test 1500 m broken, check is there any events on calendar, check is there one event (Swim test 1500 m broken)");
        ...
        //klik na Swim test 1500 m broken
        eventAdd.categoris.get(13).click();
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim test 1500 m broken 1h 00'");
