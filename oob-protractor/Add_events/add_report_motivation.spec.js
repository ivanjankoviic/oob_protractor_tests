...
describe ("Add an check event Motivation - ", function(){
    console.log("Add an check event Motivation- ");
    ...
    it ("ADD event Motivation, check is there any events on calendar, check is there one event (Motivation)", function() {
        console.log("ADD event Motivation, check is there any events on calendar, check is there one event (Motivation)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Motivation');
