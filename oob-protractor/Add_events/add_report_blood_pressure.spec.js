...
describe ("Add an check event report Blood pressure - ", function(){
    console.log("Add an check event report Blood pressure - ");
    ...
    it ("ADD event report Blood pressure, check is there any events on calendar, check is there one event (report Blood pressure)", function() {
        console.log("ADD event report Blood pressure, check is there any events on calendar, check is there one event (report Blood pressure)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Blood pressure');
