...
describe ("Add an check event goal Run Other distance - ", function(){
    console.log("Add an check event goal Run Other distance - ");
    ...
    it ("ADD event goal Other distance, check is there any events on calendar, check is there one event (goal Other distance)", function() {
        console.log("ADD event goal Other distance, check is there any events on calendar, check is there one event (goal Other distance)");
