...
describe ("Add an check event goal Fitness - ", function(){
    console.log("Add an check event goal Fitness - ");
    ...
    it ("ADD event goal Weight loss, check is there any events on calendar, check is there one event (goal Fitness)", function() {
        console.log("ADD event goal Weight loss, check is there any events on calendar, check is there one event (goal Fitness)");
