...
describe ("Add an check event Run test 5x1km - ", function(){
    console.log("Add an check event Run test 5x1km- ");
    ...
    it ("ADD event Run test 5x1km, check is there any events on calendar, check is there one event (Run test 5x1km)", function() {
        console.log("ADD event Run test 5x1km, check is there any events on calendar, check is there one event (Run test 5x1km)");
