...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (click on Bike race, check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (click on Bike race, check if fields exist, and if they are named properly");
        ...
        //Nacin da proveri text
        browser.wait(EC.presenceOf(eventAdd.categoris), 10000);
        expect(eventAdd.categoris.get(0).getText()).toBe('Bike race');
        expect(eventAdd.categoris.get(1).getText()).toBe('Time trial');
