...
describe ("Add an check event goal Others - ", function(){
    console.log("Add an check event goal Others - ");
    ...
    it ("ADD event goal Others, check is there any events on calendar, check is there one event (goal Others)", function() {
        console.log("ADD event goal Others, check is there any events on calendar, check is there one event (goal Others");
