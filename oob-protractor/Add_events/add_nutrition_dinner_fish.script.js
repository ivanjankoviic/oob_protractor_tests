...
describe ("Add an check event Fish - ", function(){
    console.log("Add an check event Fish - ");
    ...
    it ("ADD event Fish, check is there any events on calendar, check is there one event (Fish)", function() {
        console.log("ADD event Fish, check is there any events on calendar, check is there one event (Fish)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Fish');
