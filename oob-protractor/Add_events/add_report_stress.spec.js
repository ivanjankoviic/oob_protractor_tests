...
describe ("Add an check event report stress - ", function(){
    console.log("Add an check event report stress - ");
    ...
    it ("ADD event report stress, check is there any events on calendar, check is there one event (report stress)", function() {
        console.log("ADD event report stress, check is there any events on calendar, check is there one event (report stress)");
