...
describe ("Add an check event Swim test 1000 m - ", function(){
    console.log("Add an check event Swim test 1000 m- ");
    ...
    it ("ADD event Swim test 1000 m, check is there any events on calendar, check is there one event (Swim test 1000 m)", function() {
        console.log("ADD event Swim test 1000 m, check is there any events on calendar, check is there one event (Swim test 1000 m)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim test 1000 m 1h 00'");
