...
describe ("Add an check event goal Triathlon sprint - ", function(){
    console.log("Add an check event goal Triathlon sprint - ");
    ...
    it ("ADD event goal Triathlon sprint, check is there any events on calendar, check is there one event (goal Triathlon sprint)", function() {
        console.log("ADD event goal Triathlon sprint, check is there any events on calendar, check is there one event (goal Triathlon sprint)");
