...
describe ("Create 3 different events in present past and future, and delete them - ", function(){
    ...
    it ("Checking stats before and after adding event and after report that event. Event is 'Resting heart rate'", function() {
        console.log("Checking stats before and after adding event and after report that event. Event is 'Resting heart rate");
