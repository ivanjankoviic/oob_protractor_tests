...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (clik on Snack), check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (clik on Snack), check if fields exist, and if they are named properly");
        ...
        expect(eventAdd.categoris.get(1).getText()).toBe('Candy');
        expect(eventAdd.categoris.get(2).getText()).toBe('Chips');
        expect(eventAdd.categoris.get(3).getText()).toBe('Chocolate');
        expect(eventAdd.categoris.get(4).getText()).toBe('Fruit');
        expect(eventAdd.categoris.get(5).getText()).toBe('Nuts');
        expect(eventAdd.categoris.get(6).getText()).toBe('Pastry');
