...
describe ("Add an check event goal Triathlon Others - ", function(){
    console.log("Add an check event goal Triathlon Others - ");
    ...
    it ("ADD event goal Triathlon Otherscheck is there any events on calendar, check is there one event (goal Triathlon Others)", function() {
        console.log("ADD event goal Triathlon Others, check is there any events on calendar, check is there one event (goal Triathlon Others)");
