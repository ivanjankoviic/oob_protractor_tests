...
describe ("Add an check event nutrition sport nutrition Energy gels - ", function(){
    console.log("Add an check event sport nutrition Energy gels - ");
    ...
    it ("ADD event nutrition sport nutrition Energy gels, check is there any events on calendar, check is there one event (Energy gels)", function() {
        console.log("ADD event nutrition sport nutrition Energy gels, check is there any events on calendar, check is there one event (Energy gels)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Energy gels');
