...
describe ("Add an check event  Bike test 5 min - ", function(){
    console.log("Add an check event  Bike test 5 min - ");

    beforeAll(function (){
        // console.log('beforeAll');s
    ...
    it ("ADD event Bike test 5 min, check is there any events on calendar, check is there one event (Bike test 5 min)", function() {
        console.log("ADD event Bike test 5 min, check is there any events on calendar, check is there one event (Bike test 5 min)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Bike test 5 min 45'");
