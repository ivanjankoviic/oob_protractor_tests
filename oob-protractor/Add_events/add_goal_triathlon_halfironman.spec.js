...
describe ("Add an check event goal Triathlon Half ironman - ", function(){
    console.log("Add an check event goal Triathlon Half ironman - ");
    ...
    it ("ADD event goal Triathlon Half ironman check is there any events on calendar, check is there one event (goal Triathlon Half ironman)", function() {
        console.log("ADD event goal Triathlon Half ironman, check is there any events on calendar, check is there one event (goal Triathlon Half ironman)");
