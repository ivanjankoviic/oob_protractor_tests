...
describe ("Add an check event goal bike Time trial - ", function(){
    console.log("Add an check event goal bike Time trial - ");
    ...
    it ("ADD event goal bike Time trial, check is there any events on calendar, check is there one event (goal bike Time trial)", function() {
        console.log("ADD event goal bike Time trial, check is there any events on calendar, check is there one event (goal bike Time trial)");
