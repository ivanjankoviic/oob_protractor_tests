...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On /event-add/form/ (clik on Others), check if Create event field exist, and go on previous page, and chech " +
        "fields exist on event-add/menu/, and if they are named properly", function() {
        console.log("On /event-add/form/ (clik on Others), check if Create event field exist, and go on previous page, and chech " +
            "fields exist on event-add/menu/, and if they are named properly");

        //klik na Other
        // eventAdd.other.click();
