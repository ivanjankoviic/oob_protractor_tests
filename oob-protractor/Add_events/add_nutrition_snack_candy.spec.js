...
describe ("Add an check event nutrition snack Candy - ", function(){
    console.log("Add an check event nutrition snack Candy - ");
    ...
    it ("ADD event nutrition snack Candy, check is there any events on calendar, check is there one event (nutrition snack Candy)", function() {
        console.log("ADD event nutrition snack Candy, check is there any events on calendar, check is there one event (nutrition snack Candy)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Candy');
