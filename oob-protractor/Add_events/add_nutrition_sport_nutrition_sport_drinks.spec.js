...
describe ("Add an check event nutrition sport nutrition Sport drinks - ", function(){
    console.log("Add an check event sport nutrition Sport drinks - ");
    ...
    it ("ADD event nutrition sport nutrition Sport drinks, check is there any events on calendar, check is there one event (Sport drinks)", function() {
        console.log("ADD event nutrition sport nutrition Sport drinks, check is there any events on calendar, check is there one event (Sport drinks)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Sport drinks');
