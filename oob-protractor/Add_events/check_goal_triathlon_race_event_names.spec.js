...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (click on Triathlon, check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (click on Triathlon, check if fields exist, and if they are named properly");
        //klik na Goal
        eventAdd.categoris.get(1).click();
        browser.wait(EC.presenceOf(eventAdd.categoris), 5000);

        //klik na clik on Triathlon
        ...
        browser.wait(EC.presenceOf(eventAdd.categoris), 10000);
        expect(eventAdd.categoris.get(0).getText()).toBe('Sprint');
        expect(eventAdd.categoris.get(1).getText()).toBe('Olympic distance');
        expect(eventAdd.categoris.get(2).getText()).toBe('Half ironman');
        expect(eventAdd.categoris.get(3).getText()).toBe('Ironman');
