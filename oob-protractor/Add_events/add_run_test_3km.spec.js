...
describe ("Add an check event Run test 3km - ", function(){
    console.log("Add an check event Run test 3km - ");
    ...
    it ("ADD event Run test 3km, check is there any events on calendar, check is there one event (Run test 3km)", function() {
        console.log("ADD event Run test 3km, check is there any events on calendar, check is there one event (Run test 3km)");
