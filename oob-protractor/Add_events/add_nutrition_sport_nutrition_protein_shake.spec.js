...
describe ("Add an check event nutrition sport nutrition Protein shake - ", function(){
    console.log("Add an check event sport nutrition Protein shake - ");
    ...
    it ("ADD event nutrition sport nutrition Protein shake, check is there any events on calendar, check is there one event (Protein shake)", function() {
        console.log("ADD event nutrition sport nutrition Protein shake, check is there any events on calendar, check is there one event (Protein shake)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Protein shake');
