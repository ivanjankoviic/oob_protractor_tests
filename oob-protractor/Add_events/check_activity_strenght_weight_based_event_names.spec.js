...
describe ("Check if fields exist, and if they are named properly - ", function(){
    ...
    it ("On event-add/menu2/ (clik on strength weight based), check if fields exist, and if they are named properly", function() {
        console.log("On event-add/menu2/ (clik on strength weight based), check if fields exist, and if they are named properly");
        ...
        //klik na clik on strength weight based
        ...
        expect(eventAdd.categoris.get(2).getText()).toBe('Gym');
        expect(eventAdd.categoris.get(3).getText()).toBe('Circuit');
        expect(eventAdd.categoris.get(4).getText()).toBe('CrossFit');
        expect(eventAdd.categoris.get(5).getText()).toBe('Kettlebell');
        expect(eventAdd.categoris.get(6).getText()).toBe('Free weights');
        expect(eventAdd.categoris.get(7).getText()).toBe('Strength');
