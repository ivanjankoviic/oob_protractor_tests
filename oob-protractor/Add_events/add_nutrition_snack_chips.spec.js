...
describe ("Add an check event nutrition snack Nuts - ", function(){
    console.log("Add an check event nutrition snack Nuts - ");
    ...
    it ("ADD event nutrition snack Nuts, check is there any events on calendar, check is there one event (nutrition snack Nuts)", function() {
        console.log("ADD event nutrition snack Nuts, check is there any events on calendar, check is there one event (nutrition snack Nuts)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Nuts');
