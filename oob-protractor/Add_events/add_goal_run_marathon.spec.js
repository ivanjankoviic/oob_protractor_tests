...
describe ("Add an check event goal Run Marathon - ", function(){
    console.log("Add an check event goal Run Marathon - ");
    ...
    it ("ADD event goal Run Marathon, check is there any events on calendar, check is there one event (goal Run Marathon)", function() {
        console.log("ADD event goal Run Marathon, check is there any events on calendar, check is there one event (goal Run Marathon)");
