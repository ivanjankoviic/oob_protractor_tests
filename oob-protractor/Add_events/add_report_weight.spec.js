...
describe ("Add an check event Weight - ", function(){
    console.log("Add an check event Weight- ");
    ...
    it ("ADD event Weight, check is there any events on calendar, check is there one event (Weight)", function() {
        console.log("ADD event Weight, check is there any events on calendar, check is there one event (Weight)");
