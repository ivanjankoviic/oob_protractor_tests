...
describe ("Add an check event run test 5 km - ", function(){
    console.log("Add an check event 5 km - ");
    ...
    it ("ADD event run test 5 km, check is there any events on calendar, check is there one event (run test 5 km)", function() {
        console.log("ADD event run test 5 km, check is there any events on calendar, check is there one event (run test 5 km)");
