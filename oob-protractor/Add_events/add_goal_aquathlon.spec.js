...
describe ("Add an check event goal Aquathlon - ", function(){
    console.log("Add an check event goal Aqathlon - ");
    ...
    it ("ADD event goal Aquathlon, check is there any events on calendar, check is there one event (goal Aquathlon)", function() {
        console.log("ADD event goal Aquathlon, check is there any events on calendar, check is there one event (goal Aqathlon");
