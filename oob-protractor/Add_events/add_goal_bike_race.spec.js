...
describe ("Add an check event goal Bike race - ", function(){
    console.log("Add an check event goal Bike race - ");
    ...
    it ("ADD event goal Bike race, check is there any events on calendar, check is there one event (goal Bike race)", function() {
        console.log("ADD event goal Bike race, check is there any events on calendar, check is there one event (goal Bike race)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Bike race 3h 00'");
