...
describe ("Add an check event Swim test 1500 m - ", function(){
    console.log("Add an check event Swim test 1500 m - ");
    ...
    it ("ADD event Swim test 1500 m, check is there any events on calendar, check is there one event (Swim test 1500 m)", function() {
        console.log("ADD event Swim test 1500 m, check is there any events on calendar, check is there one event (Swim test 1500 m)");
        ...
        //klik na Swim test 1500 m
        eventAdd.categoris.get(12).click();
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim test 1500 m 1h 00'");
