...
describe ("Add an check event nutrition breakfast Cereal - ", function(){
    console.log("Add an check event nutrition breakfast Cereal - ");
    ...
    it ("ADD event nutrition breakfast Cereal, check is there any events on calendar, check is there one event (nutrition breakfast Cereal)", function() {
        console.log("ADD event nutrition breakfast Cereal, check is there any events on calendar, check is there one event (nutrition breakfast Cereal)");
...
//porovera i izlaz iz kada se napravi event za danasnji dan
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Cereal');
