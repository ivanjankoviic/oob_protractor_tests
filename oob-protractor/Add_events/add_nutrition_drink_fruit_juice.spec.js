...
describe ("Add an check event nutrition drink Fruit juice - ", function(){
    console.log("Add an check event drink Fruit juice - ");
    ...
    it ("ADD event nutrition drink Fruit juice, check is there any events on calendar, check is there one event (Fruit juice)", function() {
        console.log("ADD event nutrition drink Fruit juice, check is there any events on calendar, check is there one event (Fruit juice)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Fruit juice');
