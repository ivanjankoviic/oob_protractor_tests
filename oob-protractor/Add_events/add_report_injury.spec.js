...
describe ("Add an check event report Injury - ", function(){
    console.log("Add an check event report Injury - ");
    ...
    it ("ADD event report Injury, check is there any events on calendar, check is there one event (report Injury)", function() {
        console.log("ADD event report Injury, check is there any events on calendar, check is there one event (report Injury)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Injury');
