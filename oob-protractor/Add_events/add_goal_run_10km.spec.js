...
describe ("Add an check event goal Run race 10 km - ", function(){
    console.log("Add an check event goal Run race 10 km - ");
    ...
    it ("ADD event goal Run race 10 km, check is there any events on calendar, check is there one event (goal Run race 10 km)", function() {
        console.log("ADD event goal Run race 10 km, check is there any events on calendar, check is there one event (goal Run race 10 km)");
