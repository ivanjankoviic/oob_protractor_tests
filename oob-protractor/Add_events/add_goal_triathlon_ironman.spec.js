...
describe ("Add an check event goal Triathlon Ironman - ", function(){
    console.log("Add an check event goal Triathlon Ironman - ");
    ...
    it ("ADD event goal Triathlon Ironman check is there any events on calendar, check is there one event (goal Triathlon Ironman)", function() {
        console.log("ADD event goal Triathlon Ironman, check is there any events on calendar, check is there one event (goal Triathlon Ironman)");
