...
describe ("Add an check event goal Swim race - ", function(){
    console.log("Add an check event goal Swim race - ");
    ...
    it ("ADD event goal Swim race , check is there any events on calendar, check is there one event (goal Swim race )", function() {
        console.log("ADD event goal Swim race , check is there any events on calendar, check is there one event (goal Swim race )");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim race 1h 00'");
