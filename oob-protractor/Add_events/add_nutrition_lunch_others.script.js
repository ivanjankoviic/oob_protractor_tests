...
describe ("Add an check event Others - ", function(){
    console.log("Add an check event Others - ");
    ...
    it ("ADD event Others, check is there any events on calendar, check is there one event (Others)", function() {
        console.log("ADD event Others, check is there any events on calendar, check is there one event (Others)");
