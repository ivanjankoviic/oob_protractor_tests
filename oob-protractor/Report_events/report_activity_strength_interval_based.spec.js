...
* Reporting Activity - Strength interval based events with answer YES and send message
    * Create event Activity - Strength interval based - TRX, report event with answer YES *HHS 20, 40, 60 and send message
    * Create event Activity - Strength interval based - Body Weight, report event with answer YES *HHS 60, 80, 100 and send message
    * Create event Activity - Strength interval based - Circuit, report event with answer YES *HHS 20, 40, 60 and send message
    * Create event Activity - Strength interval based - Others, report event with answer YES *HHS 60, 80, 100 and send message


* Reporting Activity - Strength interval based events with answer NO and send message
    * Create event Activity - Strength interval based - TRX, report event with answer NO *skip and send message
    * Create event Activity - Strength interval based - Body Weight, report event with answer NO *injury and send message
    * Create event Activity - Strength interval based - Circuit, report event with answer NO *sick and send message
    * Create event Activity - Strength interval based - Others, report event with answer NO *not motivated and send message
...
describe ("Reporting Activity - Strength interval based events with answer YES and send message", function(){
    ...
    it ("Create event Activity - Strength interval based - TRX, report event with answer YES *HHS 20, 40, 60 and send message", function() {
        console.log("Create event Activity - Strength interval based - TRX, report event with answer YES *HHS 20, 40, 60 and send message");
        ...
        //provera naslova
        expect(createEvent.eventTitleDefault.getText()).toEqual('Activity Strength interval based TRX');
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("TRX 1h 00'");
        ...
        browser.sleep(200);
        reportEvent.timeHours.sendKeys('09');
        browser.sleep(200);
        reportEvent.timeMinutes.sendKeys('15');
        browser.sleep(200);
        ...
        //provera da li su uneseni podaci
        browser.wait(EC.presenceOf(reportEvent.timeCompleted), 5000);
        expect(reportEvent.timeCompleted.getText()).toEqual('09:15:00');
        ...
        reportEvent.writeMessage.click();
        reportEvent.newMessage.sendKeys(":) :) :* :_ :( .!.");
        reportEvent.sendMessage.click();
        ...
        expect(element(by.repeater('message in vm.event.messages').row(1)).element(by.css('[data-dc-automation="event-message-content"]')).getText()).toBe(":) :) :* :_ :( .!.");
    });

    it ("Create event Activity - Strength interval based - Body Weight, report event with answer YES *HHS 20, 40, 60 and send message", function() {
        console.log("Create event Activity - Strength interval based - Body Weight,, report event with answer YES *HHS 20, 40, 60 and send message");
        ...
        //provera naslova
        expect(createEvent.eventTitleDefault.getText()).toEqual('Activity Strength interval based Body Weight');
    ...
    it ("Create event Activity - Strength interval based - Circuit, report event with answer YES *HHS 20, 40, 60 and send message", function() {
        console.log("Create event Activity - Strength interval based - Circuit, report event with answer YES *HHS 20, 40, 60 and send message");
        ...
        //provera naslova
        expect(createEvent.eventTitleDefault.getText()).toEqual('Activity Strength interval based Circuit');
        ...
        // provera da li je event u kalendaru
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Circuit 1h 00'");
        ...
        reportEvent.skip.click();
        reportEvent.writeMessage.click();
        reportEvent.newMessage.sendKeys("123456789000/-*");
        reportEvent.sendMessage.click();
        ...
        //nacin da se proveri druga poruka
        expect(element(by.repeater('message in vm.event.messages').row(1)).element(by.css('[data-dc-automation="event-message-content"]')).getText()).toBe("123456789000/-*");


    });

    it ("Create event Activity - Strength interval based - Others, report event with answer YES *HHS 60, 80, 100 and send message", function() {
        console.log("Create event Activity - Strength interval based - Others, report event with answer YES *HHS 60, 80, 100 and send message");
        ...
        //provera naslova
        expect(createEvent.eventTitleDefault.getText()).toEqual('Activity Strength interval based Others');
        ...
        // provera da li je event u kalendaru
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Others 1h 00'");
        //klik na event i provera da li su svi elementi vidljivi
        element(by.css('[on-tap="vm.show_one_event(event)"]')).click();
        browser.sleep(300);
        ...
        browser.sleep(200);
        reportEvent.timeMinutes.sendKeys('36');
        browser.sleep(200);
        reportEvent.timeSeconds.sendKeys('14');
        browser.sleep(200);
        reportEvent.setButton.click();
        browser.sleep(200);
        browser.wait(EC.elementToBeClickable(reportEvent.happy20), 5000);
        ...
        //provera da li su uneseni podaci
        browser.wait(EC.presenceOf(reportEvent.timeCompleted), 5000);
        expect(reportEvent.timeCompleted.getText()).toEqual('12:36:14');
        ...
        reportEvent.skip.click();
        reportEvent.writeMessage.click();
        reportEvent.newMessage.sendKeys("QWEASDZCwq~~~~~");
        reportEvent.sendMessage.click();
        ...
        //nacin da se proveri druga poruka
        expect(element(by.repeater('message in vm.event.messages').row(1)).element(by.css('[data-dc-automation="event-message-content"]')).getText()).toBe("QWEASDZCwq~~~~~");
    });
});
