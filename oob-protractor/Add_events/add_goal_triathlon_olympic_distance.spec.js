...
describe ("Add an check event goal Triathlon Olympic distance - ", function(){
    console.log("Add an check event goal Triathlon Olympic distance - ");
    ...
    it ("ADD event goal Triathlon Olympic distance, check is there any events on calendar, check is there one event (goal Triathlon Olympic distance)", function() {
        console.log("ADD event goal Triathlon Olympic distance, check is there any events on calendar, check is there one event (goal Triathlon Olympic distance)");
