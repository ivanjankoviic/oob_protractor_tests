...
describe ("Add an check event nutrition drink Tea - ", function(){
    console.log("Add an check event drink Tea - ");
    ...
    it ("ADD event nutrition drink Tea, check is there any events on calendar, check is there one event (Tea)", function() {
        console.log("ADD event nutrition drink Tea, check is there any events on calendar, check is there one event (Tea)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Tea');
