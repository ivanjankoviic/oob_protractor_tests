...
describe ("Add an check event Bike test 20 min - ", function(){
    console.log("Add an check event Bike test 20 min - ");
    ...
    it ("ADD event Bike test 20 min, check is there any events on calendar, check is there one event (Bike test 20 min)", function() {
        console.log("ADD event Bike test 20 min, check is there any events on calendar, check is there one event (Bike test 20 min)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Bike test 20 min 1h 00'");
