...
describe ("Add an check event swim test 500 m - ", function(){
    console.log("Add an check event swim test 500 m - ");
    ...
    it ("ADD event swim test 500 m, check is there any events on calendar, check is there one event (swim test 500 m)", function() {
        console.log("ADD event swim test 500 m, check is there any events on calendar, check is there one event (swim test 500 m)");
        ...
        //klik na swim test 500 m
        eventAdd.categoris.get(9).click();
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Swim test 500 m 45'");
