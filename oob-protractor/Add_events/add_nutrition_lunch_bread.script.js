...
describe ("Add an check event Bread - ", function(){
    console.log("Add an check event Bread- ");
    ...
    it ("ADD event Bread, check is there any events on calendar, check is there one event (Bread)", function() {
        console.log("ADD event Bread, check is there any events on calendar, check is there one event (Bread)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Bread');
