...
describe ("Add an check event bike test 30 min - ", function(){
    console.log("Add an check event bike test 30 min - ");
    ...
    it ("ADD event bike test 30 min, check is there any events on calendar, check is there one event (bike test 30 min)", function() {
        console.log("ADD event bike test 30 min, check is there any events on calendar, check is there one event (bike test 30 min)");
        ...
        eventAdd.categoris.get(7).click();
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe("Bike test 30 min 1h 15'");
