...
describe ("Add an check event ironman - ", function(){
    console.log("Add an check event ironman - ");
    ...
    var reportEvent = new ReportEvent();
        ...
        it ("ADD event IRONMAN, check is there any events on calendar, check is there one event (IRONMAN), check names " +
        "of events in Goal ", function() {
            console.log("ADD event IRONMAN, check is there any events on calendar, check is there one event (IRONMAN), check names " +
                "of events in Goal ");
