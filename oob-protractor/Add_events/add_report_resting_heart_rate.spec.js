...
describe ("Add an check event Resting heart rate - ", function(){
    console.log("Add an check event Resting heart rate- ");
    ...
    it ("ADD event Resting heart rate, check is there any events on calendar, check is there one event (Resting heart rate)", function() {
        console.log("ADD event Resting heart rate, check is there any events on calendar, check is there one event (Resting heart rate)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Resting heart rate');
