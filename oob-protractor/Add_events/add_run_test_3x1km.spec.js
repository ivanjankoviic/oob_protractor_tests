...
describe ("Add an check event run test 3x1km - ", function(){
    console.log("Add an check event 3x1km - ");
    ...
    it ("ADD event run test 3x1km, check is there any events on calendar, check is there one event (run test 3x1km)", function() {
        console.log("ADD event run test 3x1km, check is there any events on calendar, check is there one event (run test 3x1km)");
