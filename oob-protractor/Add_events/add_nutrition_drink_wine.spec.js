...
describe ("Add an check event nutrition drink Wine - ", function(){
    console.log("Add an check event drink Wine - ");
    ...
    it ("ADD event nutrition drink Wine, check is there any events on calendar, check is there one event (Wine)", function() {
        console.log("ADD event nutrition drink Wine, check is there any events on calendar, check is there one event (Wine)");
        ...
        expect(element.all(by.repeater('event in vm.day.events')).get(1).getText()).toBe('Wine');
